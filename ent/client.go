...
import (
	...
	"github.com/renaldyhidayatt/fiberEntCrud/ent/migrate"
...
func (c *TodoClient) QueryOwner(t *Todo) *UsersQuery {
...
// QueryTodos queries the todos edge of a Users.
func (c *UsersClient) QueryTodos(u *Users) *TodoQuery {
